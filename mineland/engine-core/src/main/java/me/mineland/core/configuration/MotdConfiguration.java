...
public enum MotdConfiguration {
    ...
    private MotdConfiguration(char character, int length) {
    ...
    public static MotdConfiguration getDefaultFontInfo(char c){
        for(MotdConfiguration dFI : values()){
    ...
    public static String makeCenteredMotd(String message) {
        ...
        for (int j = 0; j < i; j++) {
            ...
            if (c == '§') {
                ...
                MotdConfiguration dFI = getDefaultFontInfo(c);
