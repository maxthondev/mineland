...
public class StringUtils {
    ...
    private static String[] MONTHS_TWO = new String[] {"01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"};

    public static String formatDateTwoBR(long ms) {
        Calendar c = Calendar.getInstance();
        c.setTime(new Date(ms));
        String day = String.valueOf(c.get(Calendar.DAY_OF_MONTH));
        String month = MONTHS_TWO[c.get(Calendar.MONTH)];
